...
<div class="container-fluid">
      ...
      <div class="row mt-1">
        ...
        <label class="col-2 col-form-label" style="">NOMBRE Y APELLIDOS:</label>
          <div class="col-6">
            <input class="form-control form-control-sm text-uppercase" value="" type="text"></input>
          </div>        
      
        <label class="col-1 col-form-label ">NIF:</label>
          <div class="col-3">
            <input class="form-control form-control-sm" type="text" value=""></input>
          </div>    
        ...
        <div class="row">
          <label class="col-2 col-form-label">TELEFONO:</label>
            <div class="col-4">
              <input class="form-control form-control-sm" value="" type="text"></input>
            </div>
